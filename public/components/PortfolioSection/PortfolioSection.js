        ...
        return (
            ...
            <div className="row">
                <div className="col-lg-4 col-sm-6 portfolio-item">
                    ...
                    <a href="/"><img className="card-img-top" src="http://placehold.it/700x400" alt="ảnh 1" /></a>
                ...
                <div className="col-lg-4 col-sm-6 portfolio-item">
                    <div className="card h-100">
                    <a href="/"><img className="card-img-top" src="http://placehold.it/700x400" alt="ảnh 2" /></a>
                    <div className="card-body">
                        <h4 className="card-title">
                ...
                <div className="col-lg-4 col-sm-6 portfolio-item">
                    <div className="card h-100">
                    <a href="/"><img className="card-img-top" src="http://placehold.it/700x400" alt="ảnh 3" /></a>
                    <div className="card-body">
                        <h4 className="card-title">
                ...
                <div className="col-lg-4 col-sm-6 portfolio-item">
                    <div className="card h-100">
                    <a href="/"><img className="card-img-top" src="http://placehold.it/700x400" alt="ảnh 4" /></a>
                    <div className="card-body">
                        <h4 className="card-title">
                ...
                <div className="col-lg-4 col-sm-6 portfolio-item">
                    <div className="card h-100">
                    <a href="/"><img className="card-img-top" src="http://placehold.it/700x400" alt="ảnh 5" /></a>
                    <div className="card-body">
                        <h4 className="card-title">
                ...
                <div className="col-lg-4 col-sm-6 portfolio-item">
                    <div className="card h-100">
                    <a href="/"><img className="card-img-top" src="http://placehold.it/700x400" alt="ảnh 6" /></a>
                    <div className="card-body">
                        <h4 className="card-title">
